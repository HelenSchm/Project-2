describe('Issue time-tracking functionality', () => {
    ...
    it('Should add and remove logged time', () => {
      ...
      //logged time is saved and estimated time is not visible
